      ...
      <div className="qna-content">
        <table className="qna-list">
          <thead className="qna-list-head">
            <tr>
              <th className="qna-col-1">No</th>
              <th className="qna-col-2">상품명</th>
              <th className="qna-col-3">게시글 제목</th>
              <th className="qna-col-4">작성일</th>
            </tr>
          </thead>
          ...
          <tbody className="qna-list-body">
            {paginatedQna.length > 0 ? (
              paginatedQna.map((qna, index) => (
                <tr key={qna.qnaNo}>
                  <td className="qna-col-1">
                    {(page - 1) * itemsPerPage + index + 1}
                  </td>
                  <td className="qna-col-2">{getProductName(qna.pdNo)}</td>
                  <td className="qna-col-3">{qna.content}</td>
                  <td className="qna-col-4">
