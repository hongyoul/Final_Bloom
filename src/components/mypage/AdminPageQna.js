...
import '../../assets/css/mypage/AdminPageQna.css';
...
function AdminMember() {
  ...
  return (
    <main className="admin-qna-container">
      <div className="admin-qna-box">
        <h5>문의 내역</h5>
      </div>

      <div className="admin-qna-content">
        <table className="admin-qna-list">
          <thead className="admin-qna-list-head">
            <tr>
          ...
          <tbody className="admin-qna-list-body">
